...
// Reference: modules/common/math/extended_kalman_filter.h from ApolloAuto
#ifndef IGGY_MATH_ESTIMATION_EXTENDED_KALMAN_FILTER_H_
#define IGGY_MATH_ESTIMATION_EXTENDED_KALMAN_FILTER_H_
...
class ExtendedKalmanFilter {
 public:
  ...
  /**
   * @brief Set transition model under zero control.
   *
   * @param f New transition model function
   * @param F New transition matrix (Linear Approximation Matrix of f)
   */
   ...
   *
   * @param h New observation model function
...
template <typename T, size_t XN, size_t ZN, size_t UN>
inline bool ExtendedKalmanFilter<T, XN, ZN, UN>::Predict(
...
template <typename T, size_t XN, size_t ZN, size_t UN>
inline bool ExtendedKalmanFilter<T, XN, ZN, UN>::Correct(
...
template <typename T, size_t XN, size_t ZN, size_t UN>
inline std::string ExtendedKalmanFilter<T, XN, ZN, UN>::DebugString() const {
...
#endif  // IGGY_MATH_ESTIMATION_EXTENDED_KALMAN_FILTER_H_
